...
<section id="top_section2" class="slide-bottom show">
	<div class="top_title_wrapper">
		...
		<h2 class="top_title"><span class="sub_title top_title_black">成長の様子</span></h2>
	</div>
	<p class="p_normal">Kids UPでは、生徒達が今までの努力の成果を披露する場として、全生徒が参加するスピーチ コンテストを毎年開催しています。</p>
	<div class="top_sec2_content">
		<div class="top_sec2_content_detail">
			<a href="https://vimeo.com/786798157/e0ff334f1d" data-lity="data-lity"><img src="<?php echo get_template_directory_uri(); ?>/img/chizuru.jpg"></a>
			<div class="name_section">
				<span class="btn_normal_narrow bcg-green" style="max-width: none;">LAND部門</span>
				<span>主に英語を始めて１年以内のお子様達が学ぶコース</span>
				<span>Chizuruさん　四谷校</span>
			</div>
			<div class="top_sec2_wrapper">
				<a href="https://vimeo.com/786798157/e0ff334f1d" class="btntransform" data-lity="data-lity">動画を見る</a>
		    </div>
		</div>
		<div class="top_sec2_content_detail">
			<a href="https://vimeo.com/786798262/f933b74968" data-lity="data-lity"><img src="<?php echo get_template_directory_uri(); ?>/img/chisato.jpg"></a>
			<div class="name_section">
				<span class="btn_normal_narrow bcg-blue1" style="max-width: none;">SKY部門</span>
				<span>主に英語を始めて１年以上のお子様達が学ぶ中級コース</span>
				<span>Chisatoさん　北品川校</span>
			</div>
			<div class="top_sec2_wrapper">
				<a class="btntransform" href="https://vimeo.com/786798262/f933b74968" data-lity="data-lity">動画を見る</a>
		    </div>
		</div>
		<div class="top_sec2_content_detail">
			<a href="https://vimeo.com/786798476/7bff24d460" data-lity="data-lity"><img src="<?php echo get_template_directory_uri(); ?>/img/saya.jpg"></a>
			<div class="name_section">
				<span class="btn_normal_narrow bcg-purple" style="max-width: none;">GALAXY部門</span>
				<span>実践的な英語を学ぶ<br>上級コース</span>
				<span>Sayaさん　田園調布雪谷校</span>
		    </div>
			<div class="top_sec2_wrapper">
				<a class="btntransform" href="https://vimeo.com/786798476/7bff24d460" data-lity="data-lity">動画を見る</a>
		    </div>
		</div>
		<div class="top_sec2_content_detail">
			<a href="https://vimeo.com/786798360/8ef20825ea" data-lity="data-lity"><img src="<?php echo get_template_directory_uri(); ?>/img/sana.jpg"></a>
			<div class="name_section">
				<span class="btn_normal_narrow bcg-yellow" style="max-width: none;">SPECIALIST部門</span>
				<span>英語で様々な教科を学ぶ<br>最上級コース</span>
				<span>Sanaさん　大島校</span>
		    </div>
			<div class="top_sec2_wrapper">
				<a class="btntransform" href="https://vimeo.com/786798360/8ef20825ea" data-lity="data-lity">動画を見る</a>
		    </div>
		</div>
	</div>
	<div class="btn_main btn_main_orange">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>achievement" class="btn bgskew"><span class="btn_title">スピーチコンテスト</span></a>
	</div>
</section><!-- end .top_section2-->
