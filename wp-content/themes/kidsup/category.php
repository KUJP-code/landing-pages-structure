			...
			<section class="title-page-header flip-page">
				<div class="page-title-wrapper">
					<?php
								...
								$cat_slug = $cat[0] -> slug;
					?>
					<h1 class="page-title"><?php echo esc_html($cat_name); ?>一覧</h1>
				</div>
					...
					<section id="archive-01" class="page-contents-section" style="padding-bottom: 0;">
						<div class="page-contents-inner">
							<section class="topics-category-wrapper">
								<a href="<?php echo esc_url( home_url( '/' ) ); ?>alltopics">新着</a>
								<a <?php if( is_category('news-cat') ) : ?>class="cat-active" <?php endif; ?> href="<?php echo esc_url( home_url( '/' ) ); ?>category/news-cat/">ニュース</a>
								<a <?php if( is_category('seasonal-cat') ) : ?>class="cat-active" <?php endif; ?> href="<?php echo esc_url( home_url( '/' ) ); ?>category/seasonal-cat">シーズナルイベント</a>
								<a <?php if( is_category('open-cat') ) : ?>class="cat-active" <?php endif; ?> href="<?php echo esc_url( home_url( '/' ) ); ?>category/open-cat/">開校情報</a>
							</section>
