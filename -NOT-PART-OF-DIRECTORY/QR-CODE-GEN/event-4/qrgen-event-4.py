...
# === Campaigns ===
campaigns = {
    "ev4": "landing",      # Landing page
    "ea4": "app-direct",   # App forwarding
}

# === QR Settings ===
qr_fill_color = "#7a4fa0"
qr_bg_color = "#f8f1e6"
image_format = "PNG"
base_url = "https://kids-up.jp/qr"

# === Output root ===
output_root = "qr_codes/event_4"
...
def generate_qr(campaign_key, school_code, school_name, medium_key, medium_name, folder_path):
    ...
    Args:
        campaign_key (str): The key for the campaign (e.g., "ev4").
...
def main():
    ...
    for medium_key, medium_name in medium_codes.items():
        if medium_key == "fl":
            ...
            combinations.append({"medium_key": "fl", "medium_name": "flyer", "campaign_key": "ev4", "folder_name": "flyer"})
            combinations.append({"medium_key": "fl", "medium_name": "flyer", "campaign_key": "ea4", "folder_name": "flyer-app"})
        else:
    ...
    print("\n🎉 All QR codes for event 4 have been generated.")
