...
output_dir = "qr_codes/event_1/looping_video"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#ev1-{school_code}-lv"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_event-1_looping_video_qr.png")
