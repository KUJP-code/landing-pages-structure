...
output_dir = "qr_codes/event_1/ticket"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#ev1-{school_code}-tx"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_event-1_ticket_qr.png")
