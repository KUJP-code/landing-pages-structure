...
output_dir = "qr_codes/event_2/tv"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#ev2-{school_code}-tv"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_event-2_tv_qr.png")
