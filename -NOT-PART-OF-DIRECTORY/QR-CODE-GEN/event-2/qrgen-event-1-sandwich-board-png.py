...
output_dir = "qr_codes/event_2/sandwich_board"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#ev2-{school_code}-sb"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_event-2_sandwich_board_qr.png")
