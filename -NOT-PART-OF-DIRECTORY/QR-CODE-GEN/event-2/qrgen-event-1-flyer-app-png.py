...
output_dir = "qr_codes/event_2/flyer_app"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#ea2-{school_code}-fl"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_event-2_flyer_qr.png")
