...
output_dir = "qr_codes/seasonal_2/postcard"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#se2-{school_code}-pc"
    ...
    # Create a PNG image
    img = qr.make_image(fill_color="#5e3e2e", back_color="white")
    
    # Generate the filename for the SVG image
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_seasonal-2_postcard_qr.png")
