...
output_dir = "qr_codes/seasonal_2/flyer_app"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#sa2-{school_code}-fl"
    ...
    # Create a PNG image
    img = qr.make_image(fill_color="#a64343", back_color="white")
    
    # Generate the filename for the SVG image
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_seasonal-2_flyer_app_qr.png")
