...
output_dir = "qr_codes/seasonal_2/poster"
...
def generate_qr_code(school_code, school_name):
    ...
    url = f"https://kids-up.jp/qr#se2-{school_code}-po"
    ...
    img_filename = os.path.join(output_dir, f"{school_code}-{school_name}_seasonal-2_poster_qr.png")
