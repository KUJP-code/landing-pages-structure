...
<img src="./beyond-minigp/images/minigp-winners.jpg" alt="" class="head-img">
	...
	<div class="about">
		...
		ここ数年、Kids UPは、MotoGPでの成功を目指す才能ある新進気鋭のレーサーたちをサポートしてきました。和玖、隼和、可穏は、いずれもレースの卓越性を目指して努力を重ねている、非常にモチベーションの高い若きアスリートたちです。彼らは非常に若い頃からスキルを磨き、スポーツで成功するための強固な基盤を築くために尽力してきました。<br>
<br>
彼らの努力はすでに実を結び始めています。2024年、隼和はMiniGP Japanシリーズで優勝し、スペインで行われたMiniGP世界大会では見事6位に入賞しました。一方、和玖は同大会で世界チャンピオンという最高の栄誉を手にしました。</p>
...
<p class="p_normal-otherpage">
しかし、トラックでの技術を習得することは、成功への道のりの一部に過ぎません。これらの若いライダーたちにとって、国際的なレースキャリアを成功させるためには、単に技術的な力量だけでなく、世界舞台で効果的にコミュニケーションを取る能力も必要です。MotoGPの世界では、英語は競技運営者やチームメンバー、スポンサー、メディアとのやり取りに不可欠な共通語となっています。<br>
<br>
そこで登場するのがKids UPです。和玖、可穏、隼和は、Kids UPの定期的なオンラインレッスンを受講しており、会話力の向上、メディアインタビューの対応方法、そしてレースキャリアに必要な専門用語を習得しています。これらのレッスンは、彼らが国際的なレースシーンで自信を持って行動できるためのスキルを提供しています。<br>
<br>
和玖と隼和はMiniGPシリーズを卒業し、次のステップが目前に迫っています。一方、2年前にMiniGPを卒業した可穏は、Women’s GPシリーズに向けて着実に前進しています。<br>
<br>
この記事では、和玖、隼和、可穏への独占インタビューを通じて、彼らの経験や抱負、そしてKids UPが彼らのレース夢の実現にどのように貢献しているかをお聞きします。キャリアの次の章に向けた彼らの洞察にご注目ください！
		</p>
	</div>
