...
<section class="hero">
    ...
    <div class="new-school-wrapper">
            ...
            <div class="h1-wrapper">
                <img src="./new-school-images-2025/naka-meguro-open-desktop.svg" alt="2/2 土"class="d-none d-sm-block hero-open-date">
             
            <h1 class="hero-h1"><span class="hero-h1-top-padding">Kids UPが <img src="./new-school-images-2025/naka-meguro-open-mobile.svg" alt="2/2 土"class="d-block d-sm-none hero-open-date"></span><br>
                中目黒に開校!<br>
        ...
        <div class="hero-bottom-wrapper">
          ...
          <div class="hero-bottom-text-wrapper">
            ...
            <h3 class="bus-service-h3-strapline">お迎えは小学校・保育園まで<br>
                お帰りはご自宅周辺に送迎！</h3>
            ...
            <p class="school-list-1">中目黒小、油面小、東山小、<br class="d-block d-sm-none">菅刈小、烏森小、猿楽小、<br >
             長谷戸小、鷹番小、不動小</p>
                ...
                <p class="school-list-2">（下目黒小・田道小は、近隣の為、<br class="d-block d-sm-none">徒歩にてご通学いただきます<br>
                 ※加計塚小上目黒小、五本木小、<br class="d-block d-sm-none">第三日野小、白金小は送迎検討中 ）</p>
            

            <h3 class="bus-service-h3-schools">送迎対象保育園・<br class="d-block d-sm-none">幼稚園</h3>
            <p class="school-list-1">送迎対象保育園を<br class="d-block d-sm-none">検討しておりますので<br>
              お早めにお問い合わせ<br class="d-block d-sm-none">ください。</p>
      ...
      <div class="container" id="div1">
        ...
        <div class="row why-choose-kidsup-row">
          ...
          <div class="col-sm-8">
            <div class="why-choose-kidsup-text-container">
              <h3 class="why-choose-kidsup-h3">
                世界基準のTOEFLの活用により<br />お子様のスピーキングスキルを可視化
              </h3>
              <p class="why-choose-kidsup-p">
                TOEFL＠Primaryスピーキングテストを実施することで、<br />
                会話力を世界基準で判定します。新たに始まった都立入試対策も万全！
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div class="tab-pane-3-inner">
                  ...
                  <h3 class="tab-pane-h3">対象年齢：10〜15歳（小4～中学生）</h3>
                  <h3 class="tab-pane-h3-orange">
                    4技能がバランス良く身に着く最上級レベル
                  </h3>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              <div class="safety-text-box">
                ...
                <h3 class="safety-text">・ 教室内の換気を徹底しています。</h3>
              </div>
            </div>
          </div>
