...
<html lang="ja">
  <head>
    ...
    <link href="./stylesheets/winter-school-custom.css" rel="stylesheet" />
    <title>Winter School 2024 at Kids UP</title>
  </head>
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="navbar">
      <div class="d-none d-md-block">
        <a class="navbar-brand d-flex w-50 me-auto" href="https://kids-up.jp/">
          <img
            src="./winter-school-images/navlogo-winter-special.svg"
            class="nav-logo"
            alt=""
          />
        </a>
...
<div class="col-sm-6 hero-col">
  <img src="./winter-school-images/winter-2024-hero.webp" alt="winter-school-hero" class="img-fluid hero-image">
</div>
...
<div class="col-sm-6 hero-col">
  ...
  <div class="hero-text-wrapper">
    <h1 class="hero-h1">冬休みはKids UPで<br>
      「留学体験」しませんか？</h1>
      <p class="hero-text">Kids UP ウィンタースクール2024 <br>お申込み受付開始！当サイトより<br>WEB申込みが可能です！ <br><span class="hero-text-small">（スクールで直接お申込みも承っております)</span></p>
...
<img src="./winter-school-images/transition-bottom-hero.webp" alt="hero-decoration" class="hero-decoration-bottom">
</div>
</section>
    ...
    <section class="event-about" style="padding-bottom: 0rem;">
      <img src="./winter-school-images/transition-top-about.webp" alt="hero-decoration" class="about-decoration-top">
      <div class="container" id="div1">
        <div class="row">
          <div class="col-sm-7 explainer-top-left">
            <h2 class="section-h2 about-h2">
              今年の冬はKids UPで<br>楽しく留学体験！
            </h2>
            <p class="about-p">
              キッズアップのウィンタースクールへようこそ！<br>
              英語初心者でも上級者でも関係なく楽しめるアクティビティが揃っています！<br>
              <br>
              工作、雪遊び、クッキングなど、様々なアクティビティを日替わりで行いますので毎日参加しても楽しめます！<br>
              <br>
              プログラムはオールイングリッシュで行われるため、お子様は自然な英語力を身につけることができます。 英語に自信がなくても大丈夫！経験豊富でフレンドリーな先生たちがお子様をサポートいたします。<br>
              <br>
              忘れられない冬の思い出を一緒に作りましょう！
            </p>
          </div>
          <div class="col-sm-5">
            <img
              src="./winter-school-images/about-boy-decoration.webp"
              alt="explainer-top"
          ...
          <h2 class="section-h2 h2 about-h2">人気アクティビティ</h2>
    ...
    <img src="./winter-school-images/transition-bottom-events-dropdown.webp" alt="" class="dropdown-decoration-bottom">
    </section>
...
<div >
      ...
      <div class="container">
        ...
        <h2 class="section-h2" id="div2" style="color: #4f4538;">こんなお声をいただきました♪</h2>
    ...
    <section class="four-benefits-wrapper  bg-snow-decoration">
      ...
      <div class="container four-benefits-container">
        <img src="./winter-school-images/four-reasons-top-decoration-1.webp" alt="boy making a giant snowball" class="four-benefits-top-decoration-1">
        <img src="./winter-school-images/four-reasons-top-decoration-2.webp" alt="boy making a giant snowball" class="four-benefits-top-decoration-2">
        <!-- main-parent-row -->
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-12 benefit-icon-child-col-img">
                <img
                  src="./winter-school-images/reason-1.svg"
                  alt="benefit-icon-1"
                  class="benefit-icon"
                />
              </div>
          ...
          <div class="col-xl-3 col-md-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-12 benefit-icon-child-col-img">
                <img
                  src="./winter-school-images/reason-2.svg"
                  alt="benefit-icon-2"
                  class="benefit-icon"
                />
              </div>
          ...
          <div class="col-xl-3 col-md-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-12 benefit-icon-child-col-img">
                <img
                  src="./winter-school-images/reason-3.svg"
                  alt="benefit-icon-3"
                  class="benefit-icon"
                />
              </div>
          ...
          <div class="col-xl-3 col-md-6 col-xs-12">
            ...
            <div class="row">
              <div class="col-12 benefit-icon-child-col-img">
                <img
                  src="./winter-school-images/reason-4.svg"
                  alt="benefit-icon-4"
                  class="benefit-icon"
                />
              </div>
    ...
    <!---------------------------------------------------------------- call to action ---------------------------------------------------------------->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <img
              src="./winter-school-images/call-to-action-decoration.webp"
              alt=""
      ...
      <img src="./winter-school-images/transition-bottom-cta.webp" alt="" class="decoration-cta-bottom">
    </section>
    <!---------------------------------------------------------------- about activities---------------------------------------------------------------->
    ...
    <div class="activity-info-div" id="div3">
      ...
      <div class="container">
        ...
        <div class="d-none d-sm-block" style="padding-bottom: 2rem;">
          <!-- TOKYO --------------------->
          ...
          <div class="col-sm-6">
           ...
           <div class="row location-row">
            ...
            <div class="col-sm-6">
              <div class="location-area-wrapper"> 
                 <div class="location-outer">
                    <img src="./winter-school-images/map-pin-3.svg" alt="map-pin-2" class="location-pin">          <h3 class="location-name-3">浦安市</h3>
                 </div>
    ...
    <img src="./winter-school-images/transition-bottom-about.webp" alt="" class="about-decoration-bottom" style="position: absolute; margin-bottom: -2rem; padding-top: 2rem;">
    </div>
    ...
    <div class="bottom-section bg-snow-decoration" id="div4">
      ...
      <!---------------------------------------------------------------- Section 10 - FAQ ---------------------------------------------------------------->
      <div class="container">
        <h2 class="section-h2 about-h2">よくあるご質問</h2>
        <div class="accordion" id="faqAccordion">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
              ...
              >
                <img
                  src="./winter-school-images/accordion-btn.svg"
                  alt="accordion-btn"
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                               <p class="accordion-text">
                  最長20:30までお預かりが可能です。30分単位で延長料金が発生いたします。
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                               <p class="accordion-text">
                  多彩なプログラムを通して、楽しみながら英語を学んでいただきます。
    ...
    <section class="sign-up" id="div5">
        ...
        <div class="row sign-up-row">
          <div class="col-sm-4">
            <div class="sign-up-wrapper-left">
              <img
                src="./winter-school-images/sign-up-step-1.svg"
                alt="sign-up-step-1"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
          ...
          <div class="col-sm-4">
            <div class="sign-up-wrapper-middle">
              <img
                src="./winter-school-images/sign-up-step-2.svg"
                alt="sign-up-step-2"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
          ...
          <div class="col-sm-4">
            <div class="sign-up-wrapper-right">
              <img
                src="./winter-school-images/sign-up-step-3.svg"
                alt="sign-up-step-3"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
      ...
      <img src="./winter-school-images/transition-bottom-events-signup.webp" alt="" class="decoration-cta-bottom">
    </section>

    <!---------------------------------------------------------------- pre-footer ---------------------------------------------------------------->
    <img src="./winter-school-images/transition-top-prefooter.webp" alt="" class="decoration-activities-top" style="background-color: #e8dccd;">
    ...
    <script src="winter-javascript.js"></script>
    <script>
