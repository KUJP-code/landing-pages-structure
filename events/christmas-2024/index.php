...
<html lang="ja">
  <head>
    ...
    <meta
      property="og:image"
      content="https://kids-up.jp/events/science-fair-2024/christmas-2024-images/fb-main.webp"
    />
...
<div class="col-sm-6 hero-col">
  ...
  <div class="hero-text-wrapper">
    <img src="./christmas-2024-images/hero-decoration-1.svg" alt="hero-decoration-1" class="hero-decoration-1">
    ...
    <section class="event-about">
      <div class="container" id="div1">
        <div class="row">
          ...
          <div class="col-sm-6">
            <img
              src="./christmas-2024-images/about-image.png"
              alt="explainer-top"
...
<div class="col-sm-4 about-event-column">
  <img src="./christmas-2024-images/about-decoration-1.webp" alt="about-decoration-1" class="about-event-decoration-1">
  <img src="./christmas-2024-images/about-benefit-icon-1.svg" alt="about-benefit-icon-1" class="about-benefit-icon">
  <h3 class="about-event-h3">初心者から上級生まで、<br>
    全ての方にご参加いただけます</h3>
    <p class="about-event-p">満３歳以上のお子様ならどなたでも楽しくご参加いただけますのでご安心ください！
      上級生は海外留学をしたような経験が得られます！</p>
</div>

<div class="col-sm-4 about-event-column">
  <img src="./christmas-2024-images/about-benefit-icon-2.svg" alt="about-benefit-icon-2.svg" class="about-benefit-icon">
  <h3 class="about-event-h3">お好きなお時間を<br>
    お選びいただけます</h3>
    <p class="about-event-p">時間が選べるから、他に用事が あっても大丈夫！
      ※定員になり次 第〆切となりますので、お早めに お申し込みください。</p>
</div>

<div class="col-sm-4 about-event-column">
  <img src="./christmas-2024-images/about-decoration-2.webp" alt="about-decoration-2" class="about-event-decoration-2">
  <img src="./christmas-2024-images/about-benefit-icon-3.svg" alt="about-benefit-icon-3.svg" class="about-benefit-icon">
...
<!-- TOKYO --------------------->
       <img src="./christmas-2024-images/tokyo.svg" class="prefecture-title" alt="東京都">     
...
<div class="location-outer">
  <img src="./christmas-2024-images/map-pin-1.svg" alt="map-pin-1" class="location-pin">
...
<div class="col-sm-6">
 ...
 <!-- KANAGAWA --------------------->
 <img src="./christmas-2024-images/kanagawa.svg" class="prefecture-title" alt="神奈川県">     
 <div class="row location-row">
  <div class="col-sm-6">
     <div class="location-area-wrapper"> 
        <div class="location-outer">
           <img src="./christmas-2024-images/map-pin-2.svg" alt="map-pin-2" class="location-pin">
...
<div class="col-sm-6">
 ...
 <!-- CHIBA --------------------->
 <img src="./christmas-2024-images/chiba.svg" class="prefecture-title" alt="千葉県">     
 <div class="row location-row">
  <div class="col-sm-6">
     <div class="location-area-wrapper"> 
        <div class="location-outer">
           <img src="./christmas-2024-images/map-pin-3.svg" alt="map-pin-2" class="location-pin">
 ...
 <!-- SAITAMA--------------------->
 <img src="./christmas-2024-images/saitama.svg" class="prefecture-title" alt="埼玉">     
 <div class="row location-row">
  <div class="col-sm-3">
     <div class="location-area-wrapper"> 
        <div class="location-outer">
           <img src="./christmas-2024-images/map-pin-4.svg" alt="map-pin-2" class="location-pin">
  ...
  <div class="mobile-accordion-item">
    <h2 class="accordion-header" id="locationHeadingOne">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#locationCollapseOne" aria-expanded="false" aria-controls="locationCollapseOne" style="background-color: transparent; padding: 0; border: none;">
        <img src="./christmas-2024-images/mobile-accordion-1.svg" alt="東京都" class="mobile-accordion-button">
      </button>
    </h2>
  ...
  <div class="mobile-accordion-item">
    <h2 class="accordion-header" id="locationHeadingTwo">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#locationCollapseTwo" aria-expanded="false" aria-controls="locationCollapseTwo" style="background-color: transparent; padding: 0; border: none;">
        <img src="./christmas-2024-images/mobile-accordion-2.svg" alt="神奈川県" class="mobile-accordion-button">
      </button>
    </h2>
  ...
  <div class="mobile-accordion-item">
    <h2 class="accordion-header" id="locationHeadingThree">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#locationCollapseThree" aria-expanded="false" aria-controls="locationCollapseThree" style="background-color: transparent; padding: 0; border: none;">
        <img src="./christmas-2024-images/mobile-accordion-3.svg" alt="千葉県" class="mobile-accordion-button">
      </button>
    </h2>
  ...
  <div class="mobile-accordion-item">
    <h2 class="accordion-header" id="locationHeadingFour">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#locationCollapseFour" aria-expanded="false" aria-controls="locationCollapseFour" style="background-color: transparent; padding: 0; border: none;">
        <img src="./christmas-2024-images/mobile-accordion-4.svg" alt="埼玉県" class="mobile-accordion-button">
      </button>
    </h2>
...
<div class="container event-section">
  ...
  <div class="activity-box-1">
    ...
    <div class="activity-box-1-inner">
        <h2 class="event-header event-header-1">クリスマスハットカップケーキ</h2>
...
<img src="./christmas-2024-images/activity-decoration-2.webp" alt="activity-decoration-2" class="activity-decoration-2">
  ...
  <h2 class="event-header event-header-2">サンタに会おう！</h2>
  <p class="event-text event-text-2">サンタがKids UPにやって来るよ！<br>
    英語で話して、友達やサンタと<br>
    一緒に写真を撮ろう★
  </p>
</div>
...
<div class="activity-box-3-inner-wrapper-2">
  ...
  <p class="event-text event-text-1">ベルを叩いてトナカイを走らせよう！友達と熱いバトルを繰り広げて、
    誰のトナカイが一番早くゴールに辿り着くかな？勝利を手にするのは君だ！
      ...
      <div class="carousel-div" style="position: relative">
          ...
          <div class="swiper" id="image-carousel">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <figure>
                  <img
                    src="./christmas-2024-images/gallery/gallery-1.webp"
                    alt="img-1"
                    class="swiper-img"
                  />
                </figure>
              ...
              <div class="swiper-slide">
                <figure>
                  <img
                    src="./christmas-2024-images/gallery/gallery-2.webp"
                    alt="img-2"
                    class="swiper-img"
                  />
                </figure>
              ...
              <div class="swiper-slide">
                <figure>
                  <img
                    src="./christmas-2024-images/gallery/gallery-4.webp"
                    alt="img-4"
                    class="swiper-img"
                  />
                </figure>
              ...
              <div class="swiper-slide">
                <figure>
                  <img
                    src="./christmas-2024-images/gallery/gallery-5.webp"
                    alt="img-5"
                    class="swiper-img"
                  />
                </figure>
            ...
            <div class="swiper-custom-nav large-display">
              <img
                src="./christmas-2024-images/arrow-left.svg"
                alt="arrow-left"
                class="swiper-custom-nav-arrow swiper-button-left"
              />
              <img
                src="./christmas-2024-images/arrow-right.svg"
                alt="arrow-right"
        ...
        <img src="./christmas-2024-images/transition-gallery-signup.svg" alt="transition-gallery-signup" class="transition-gallery-signup">
      </div>
        ...
        <div class="row sign-up-row">
          <div class="col-sm-4">
            <div class="sign-up-wrapper-left">
              <img
                src="./christmas-2024-images/sign-up-step-1.svg"
                alt="sign-up-step-1"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
          ...
          <div class="col-sm-4">
            <div class="sign-up-wrapper-middle">
              <img
                src="./christmas-2024-images/sign-up-step-2.svg"
                alt="sign-up-step-2"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
          ...
          <div class="col-sm-4">
            <div class="sign-up-wrapper-right">
              <img
                src="./christmas-2024-images/sign-up-step-3.svg"
                alt="sign-up-step-3"
                class="img-fluid"
              />
              <h3 class="sign-up-h3">
                Kids UPのクリスマスパーティー<br />
                イベント当日
              </h3>
              <p class="sign-up-p">
    ...
    <!---------------------------------------------------------------- pre-footer ---------------------------------------------------------------->
    <img src="./christmas-2024-images/transition-signup-prefooter.svg" alt="" class="transition-gallery-signup" style="background-color: #892c3c;">
