...
<head>
  ...
  <link rel="stylesheet" href="./stylesheets/winter-school.css" />

<title>Kids UP Winter School 2025</title>
...
<div class="hero-inner">
  ...
  <div class="text-col">
    ...
    <h1>ワクワクがいっぱい！<br>
    キッズアップの<br class="break">ウィンタースクール！</h1>

    <p>
インドア雪合戦やサンタスライムなど、<br>
ワクワクするアクティビティで楽しみながら英語力アップ！<br>
日替わりのアクティビティで先生やお友達と一緒に<br>
寒い冬を楽しもう★<br>
<br>
【ウィンタースクール2025-26 申込受付中】<br>
...
<div class="image-slider">
  ...
  <div class="image-track-1">
    <img src="./assets/images/hero/hero-cards/hero-card-01.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-02.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-03.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-04.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-05.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-06.jpg" alt="">
    ...
    <div class="image-track-2">
    <img src="./assets/images/hero/hero-cards/hero-card-07.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-08.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-09.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-10.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-11.jpg" alt="">
    <img src="./assets/images/hero/hero-cards/hero-card-12.jpg" alt="">
...
<img src="./assets/images/background-transitions/hero-bg-bottom.svg" alt="" class="hero-bottom-transition">
  ...
  <div class="container">
    ...
    <div class="text">
    <h2>遊びながら英語に触れよう！<br>
Kids UPのウィンタースクール★</h2>
<br>
    <p>楽しく英語を学べる特別なアクティビティがたくさん！<br>
お菓子の家作りやニューイヤーパーティー、ラジコンでサッカーバトルなど、<br>
冬を満喫できる楽しいアクティビティが勢ぞろい♪<br>
</p>
...
<div class="image-column">
  <img src="./assets/images/about-event/winter-teachers.png" alt="teachers" class="img-fluid">
</div>
...
<div class="container prefecture-wrapper">
  ...
  <img src="./assets/images/misc/boom-tale.svg" alt="" class="boom-tale">
</div>
  ...
  <div class="container">
    ...
    <div class="customer-feedback-column-wrapper">
      ...
      <div class="item item-1">
        ...
        <p> 毎年、子供が行きたいアクティビティに参加させています。自分の好きなことなので、英語を習得しているという意識はなく、楽しみながら英語が身についています！</p>
      ...
      <div class="item item-2">
        ...
        <p>毎回参加するたびに「楽しかった！」と言って帰ってきます。年齢に関係なく皆でアクティビティを行うので、年上のお友達からたくさんいい刺激をもらっているようです。</p>
      ...
      <div class="item item-3">
        ...
        <p> シーズナルスクールに参加すると、他の学校の子とお友達になれるのが嬉しいです！先生や友達と英語でゲームをするのが楽しいです。</p>
...
<div class="four-benefits-wrapper">
  ...
  <div class="benefit">
    <div class="benefit-icon-box">
<?xml version="1.0" encoding="UTF-8"?>
<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212.5 212.5">
...
<div class="image">
  <img src="./assets/images/misc/cta-img.png" alt="Happy Teacher" class="winter-girl">
</div>
...
async function loadActivities() {
  ...
  try {
    const response = await fetch('/events/winter-school-2025/assets/includes/activities.json');
...
<section class="seasonal-dropdowns">
  <div class="container">
    ...
    <div class="dropdown-section" id="calendar">
      <img src="./assets/images/dropdowns/calendar.png" alt="カレンダー">

      <a href="./assets/pdf/カレンダー.pdf" class="cta-button cta-secondary" target="_blank">カレンダーをダウンロード</a>
    </div>
    ...
    <div class="dropdown-section" id="pricing">
      <img src="./assets/images/dropdowns/prices.svg" alt="料金表" >

      <a href="./assets/pdf/料金表.pdf" class="cta-button cta-secondary" target="_blank">料金表をダウンロード</a>
    </div>

    <div class="dropdown-section" id="info">
      <img src="./assets/images/dropdowns/about.svg" alt="ご案内">


      <a href="./assets/pdf/ご案内.pdf" class="cta-button cta-secondary" target="_blank">ご案内をダウンロード</a>
    </div>
  ...
  <div class="container">
    ...
    <div class="accordion-wrapper">
      ...
      <div class="accordion-item">
        ...
        <div class="accordion-content">
          <p>指定の小学校・保育園までのお迎えと、 ご自宅付近の停車場所までお送りする「無料送迎サービス」がございます。<br>
            ※レギュラーコースにご通学の方のみご利用いただけます。　ウィンタースクールのみご参加の方には対応いたしておりません。</p>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <img src="./assets/images/misc/echo-jot.svg" alt="" class="echo-jot">
  </div>
</section>
...
<svg id="Layer_4_copy" data-name="Layer 4 copy" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 511.3 535.35">
  ...
  <path id="Path_352-2" data-name="Path 352-2" class="sign-up-stroke" d="M431.71,389.72c0,10.36-8.5,18.87-18.87,18.87h-100.59c-10.36,0-18.87-8.5-18.87-18.87v-179.11c0-10.36,8.5-18.87,18.87-18.87h100.59c10.36,0,18.87,8.5,18.87,18.87v179.11ZM79.59,370.85v-9.04h96.33l10.36,25.78c.93,2.39,3.32,3.99,5.85,3.99h89.03c.4,6.25,2.52,12.22,6.25,17.14H117.46c-20.99-.13-37.87-17.01-37.87-37.87M196.25,378.96l-6.91-17.14h91.42v17.14h-84.51ZM103.38,168.22c0-9.57,7.84-17.41,17.41-17.41h249.27c9.57,0,17.41,7.84,17.41,17.41v11.03h-75.21c-17.41,0-31.36,14.08-31.49,31.49v138.59H103.24v-181.11h.13ZM412.84,179.25h-12.89v-11.03c0-16.61-13.42-30.03-30.03-30.03H120.65c-16.61,0-30.03,13.42-30.03,30.03v181.11h-17.54c-3.45,0-6.25,2.79-6.25,6.25h0v15.28c0,27.77,22.59,50.23,50.36,50.36h295.51c17.41,0,31.36-14.08,31.49-31.49v-179.11c.13-17.27-13.95-31.36-31.36-31.36"/>
    ...
    <h3>WEBフォームよりお申込み</h3>
    <p>WEBフォームよりKids UPのウィンタースクールにお申込みが可能です。お申込みフォームより入力のうえ、お申込みください。</p>
