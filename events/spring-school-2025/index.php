...
<html lang="ja">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="navbar" style="  background-color: #5f5ba8;">
...
<img src="./winter-school-images/transition-bottom-hero.webp" alt="hero-decoration" class="hero-decoration-bottom">
    ...
    <img src="./winter-school-images/transition-bottom-about.webp" alt="" class="about-decoration-bottom">
    </section>
...
<div class="">
    ...
    <div class="activity-info-div" id="div3">
      ...
      <div class="container">
        <h2 class="section-h2">人気アクティビティ</h2>
        <div class="swiper-arrow-container">
