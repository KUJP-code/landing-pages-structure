...
<title>Kids UP Newsletter Vol 10
</title>
...
<link rel="stylesheet" href="../newsletter-common-assets/common-v3.css">
<link rel="stylesheet" href="./assets/vol-10-style.css">
...
<link href="https://fonts.googleapis.com/css2?family=BIZ+UDGothic&family=Noto+Sans+JP:wght@100..900&family=Shippori+Mincho+B1&display=swap" rel="stylesheet">
...
<div class="hero hero-outer">
  <div class="container">
    <div class="hero-datebox">
      <p class="hero-date">January 2026</p>
      <p class="hero-volume">VOLUME 10</p>
    </div>
...
<div class="tenth-badge">
  <img src="./assets/images/hero/10th-outer.svg" alt="" class="spin">
    <img src="./assets/images/hero/10th-inner.svg" alt="" class="ten-years-img">
</div>
...
<div class="container overflow-hidden swiper-parent-container">
  <div class="swiper-container article-selec">
    <div class="swiper-wrapper">


      <div class="swiper-slide article-selector-slide">
        <img
          src="./assets/images/top-slider/article-1.jpg"
          alt="Card 1"
        />
      ...
      <div class="swiper-slide article-selector-slide">
        <img
          src="./assets/images/top-slider/article-2.jpg"
          alt="Card 2"
        />
        <p class="article-selector-text">
          立ち上げ期を知るメンバーによる、<br>
      ...
      <div class="swiper-slide article-selector-slide">
        <img
          src="./assets/images/top-slider/article-3.jpg"
          alt="Card 3"
        />
        <p class="article-selector-text">
          歴史コーナー
...
<div class="contents">
 ...
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2026-vol-10/articles/vol-10-article-1.php'; ?>
 </div>
 
 
 
 <div class="selected-article article-2-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2026-vol-10/articles/vol-10-article-2.php'; ?>
 </div>
 

   <div class="selected-article article-3-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2026-vol-10/articles/vol-10-article-3.php'; ?>
 </div>

 
  <div class="selected-article article-4-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2026-vol-10/articles/vol-10-article-4.php'; ?>
 </div>
