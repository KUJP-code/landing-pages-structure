...
<title>Kids UP Newsletter Vol 9
</title>
...
<link rel="stylesheet" href="./assets/vol-9-style.css">
<link rel="stylesheet" href="./assets/vol-9-style.css">
...
<div class="hero hero-outer">
  <div class="container">
    <div class="hero-datebox">
      <p class="hero-date">September 2025</p>
      <p class="hero-volume">VOLUME 9</p>
    </div>

    <div class="hero-contents-wrapper">
    <h1>
      Kids UP<br> Newsletter
    </h1>
    </div>
  </div>
  ...
  <div class="swiper-container">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide">
        ...
        />
        <p class="swiper-slide-text">
          「楽しいだけ」で終わらない。――Kids UPのキャンプは、子どもたちが挑戦を通じて大きく成長する特別な時間です。
...
<div class="contents">
 ...
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-1.php'; ?>
 </div>
 
 
 
 <div class="selected-article article-2-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-2.php'; ?>
 </div>
 

   <div class="selected-article article-3-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-3.php'; ?>
 </div>

  <div class="selected-article article-4-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-4.php'; ?>
 </div>
 
 <div class="selected-article article-5-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-5.php'; ?>
 </div>
 
 <div class="selected-article article-6-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-6.php'; ?>
 </div>
 
 <div class="selected-article article-7-selected">
 <?php include $_SERVER['DOCUMENT_ROOT'] . '/newsletters/2025-vol-9/articles/vol-9-article-7.php'; ?>
 </div>
...
<?php include $_SERVER['DOCUMENT_ROOT'] . '/global/global-includes/global-footer-no-recruit.php'; ?>
